...
public class DispatchTransportMessageObserverFixture
{
    ...
    public async Task Should_be_able_to_dispatch_message_to_outbox_async()
    {
        ...
        outboxTransport.Verify(m => m.SendAsync(It.IsAny<Stream>(), It.IsAny<IPipeline>(), It.IsAny<CancellationToken>()), Times.Once);
    ...
    public async Task Should_be_able_to_dispatch_message_to_recipient_async()
    {
        ...
        recipientTransport.Verify(m => m.SendAsync(It.IsAny<Stream>(), It.IsAny<IPipeline>(), It.IsAny<CancellationToken>()), Times.Once);
