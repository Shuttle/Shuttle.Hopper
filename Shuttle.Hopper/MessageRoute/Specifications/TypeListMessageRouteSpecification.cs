...
{
    protected readonly List<string> MessageTypes = [];
    ...
    {
        var typeNames = Guard.AgainstEmpty(value).Split(';', StringSplitOptions.RemoveEmptyEntries);
        ...
        foreach (var typeName in typeNames)
        {
            ...
            MessageTypes.Add(Guard.AgainstEmpty(type.FullName));
        }
    }
